...
namespace PSReptile.Models.Maml
{
    ...
    public class Command
    {
        ...
        [XmlElement("syntax", Namespace = Constants.XmlNamespace.Command, Order = 2)]
        public string Syntax { get; set; }

        [XmlElement("parameters", Namespace = Constants.XmlNamespace.Command, Order = 3)]
        public string Parameters { get; set; }

        [XmlElement("inputTypes", Namespace = Constants.XmlNamespace.Command, Order = 4)]
        public string InputTypes { get; set; }

        [XmlElement("returnValues", Namespace = Constants.XmlNamespace.Command, Order = 5)]
        public string ReturnValues { get; set; }

        [XmlElement("alertSet", Namespace = Constants.XmlNamespace.MAML, Order = 6)]
        public string AlertSet { get; set; }

        [XmlElement("examples", Namespace = Constants.XmlNamespace.Command, Order = 7)]
        public string Examples { get; set; }

        [XmlElement("relatedLinks", Namespace = Constants.XmlNamespace.MAML, Order = 8)]
